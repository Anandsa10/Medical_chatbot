...
<div class="container-fluid p-0">
	...
	<div id="about" class="col-md-12 pt-4 pb-4">
		<div class="col-md-8 mx-auto mt-4 text-center pt-4 pb-4">
			...
			<p class="mt-4 text-dark">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
		</div>
	</div>
